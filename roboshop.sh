...
do
     ...
     IP=$(aws ec2 describe-instances --instance-ids i-0126d04edee05925c --query 'Reservations[0].Instances[0].PrivateIpAddress' --output text)
    else
      IP=$(aws ec2 describe-instances --instance-ids i-0126d04edee05925c --query 'Reservations[0].Instances[0].PublicIpAddress' --output text)
    fi
